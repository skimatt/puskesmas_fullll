...
<div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <h2 class="text-3xl font-bold text-gray-800 mb-6">Riwayat Kunjungan</h2>
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-gray-100">
                        ...
                        <th class="p-3">Tanggal Kunjungan</th>
                    ...
                    <?php if ($riwayat): ?>
                        <?php foreach ($riwayat as $r): ?>
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="p-3"><?= date('d-m-Y', strtotime($r->tanggal_kunjungan)); ?></td>
                                <td class="p-3"><?= $r->diagnosa; ?></td>
                                <td class="p-3"><?= $r->tindakan; ?></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="5" class="p-3 text-gray-600 text-center">Belum ada riwayat kunjungan.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
