...
<html
  ...
  <base href="<?= base_url('assets/'); ?>">
    ...
    <title><?= isset($title) ? htmlspecialchars($title) : 'Login - Puskesmas Digital'; ?></title>
      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-flex col-12 col-lg-4 align-items-center authentication-bg p-sm-12 p-6">
          <div class="w-px-400 mx-auto mt-12 pt-5">
            <h4 class="mb-1"><i class="fas fa-clinic-medical mr-2"></i> Login - Puskesmas Digital</h4>
            ...
            <?= form_open('auth/login', ['id' => 'formAuthentication', 'class' => 'mb-6']); ?>
              <div class="mb-6">
              ...
              <div class="mb-6 form-password-toggle">
                ...
                <?= form_error('password', '<p class="text-danger text-sm mt-1">', '</p>'); ?>
              </div>
              <div class="my-8">
